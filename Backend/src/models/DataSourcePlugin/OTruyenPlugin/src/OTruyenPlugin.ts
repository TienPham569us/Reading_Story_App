...
export default class OTruyenPlugin implements IDataSourcePlugin {
  name: string;
  ...
  static baseUrl: string = 'https://otruyenapi.com/v1/api';
  public constructor(
    name: string,
    listCategory: ICategoryList,
    contentChapter: IContentStory,
  ...
  public async newestStoryAtCategory(
    ...
    return Promise.resolve(OTruyenPlugin.baseUrl);
  }
